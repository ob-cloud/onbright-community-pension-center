        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="12">
            <a-form-item label="工单编号">
              <a-input placeholder="请输入工单编号" v-model="queryParam.id"></a-input>
            </a-form-item>
          </a-col>

          <a-col :md="6" :sm="8">
            <a-form-item label="工单标题">
              <a-input placeholder="请选择工单标题" v-model="queryParam.title"></a-input>
            </a-form-item>
          </a-col>
          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="工单类型">
                <a-select v-model="queryParam.type" placeholder="请选择工单类型">
                  <a-select-option value="">请选择</a-select-option>
                  <a-select-option value="0">报障工单</a-select-option>
                  <a-select-option value="1">申购工单</a-select-option>
                  <a-select-option value="2">其他工单</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="工单状态">
                <a-select v-model="queryParam.status" placeholder="请选择订单状态">
                  <a-select-option value="">请选择</a-select-option>
                  <a-select-option value="0">已完结</a-select-option>
            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="紧急程度">
                <a-select v-model="queryParam.urgent" placeholder="请选择紧急程度">
                  <a-select-option value="">请选择</a-select-option>
        ...
        <span slot="action" slot-scope="text, record">
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-if="record.status === 2" @click="handleOrderArrange(record)">
                <a>跟进</a>
              </a-menu-item>

              <a-menu-item v-if="record.status === 1" @click="handleOrderVisit(record)">
                <a>上门</a>
              </a-menu-item>
