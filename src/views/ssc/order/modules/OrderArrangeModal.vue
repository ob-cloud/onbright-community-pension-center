  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="护理对象" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'wechatUserParentName', {}]" :readOnly="true" />
        </a-form-item>
        <a-form-item label="护工" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select v-decorator="[ 'nursingWorker', {}]" placeholder="请选择护工">
            <a-select-option value="1">李多海</a-select-option>
            <a-select-option value="2">姜雨杉</a-select-option>
          </a-select>
        </a-form-item>

        <a-form-item label="提醒对象" :labelCol="labelCol" :wrapperCol="wrapperCol">
