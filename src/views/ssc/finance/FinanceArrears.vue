<template>
  <a-card :bordered="false">
    ...
    <finance-arrears-modal ref="modalForm" @ok="modalFormOk"></finance-arrears-modal>
  </a-card>
</template>
...
<script>
  ...
  import FinanceArrearsModal from './modules/FinanceArrearsModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/finance/getFinanceArrearsList',
