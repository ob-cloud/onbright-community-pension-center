          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="订单号">
                <a-input placeholder="请输入订单号" v-model="queryParam.customerName"></a-input>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="护工">
                <a-input placeholder="请输入护工名称" v-model="queryParam.customerName"></a-input>
              </a-form-item>
            </a-col>
          </template>
        ...
        <span slot="action" slot-scope="text, record">
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-if="record.status === 0" @click="handleOrderArrange(record)">
                <a>跟进</a>
              </a-menu-item>

              <a-menu-item v-if="record.status === 2" @click="handleOrderVisit(record)">
                <a>上门</a>
              </a-menu-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        path: {
          detail: this.$routePath.SSC_SERVICE_ORDER_DETAIL
        }
      }
    },
    methods: {
