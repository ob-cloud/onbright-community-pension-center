          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="审批状态">
                <a-select v-model="queryParam.serviceStatus" placeholder="请选择审批状态">
                  <a-select-option value="">请选择</a-select-option>
                  <a-select-option value="0">等待审批</a-select-option>
                  <a-select-option value="1">审批通过</a-select-option>
                  <a-select-option value="2">审批否决</a-select-option>
                  <a-select-option value="3">驳回审批</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="申请机构">
                <a-input placeholder="请输入申请机构" v-model="queryParam.customerName"></a-input>
              </a-form-item>
            </a-col>
          </template>
